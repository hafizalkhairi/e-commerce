                    ...
                    <div class="card-body">
                        <table id="example" class="display" style="min-width: 845px; text-align:center;">
                            ...
                            <tbody>
                                ...
                                $query = mysqli_query($conn, "SELECT * FROM transaksi JOIN rekening ON  transaksi.id_rekening=rekening.id_rekening JOIN users ON transaksi.id_users=users.id_users WHERE transaksi.status_transaksi = 'SELESAI' ORDER BY code ASC");
                                ?>
